...
/** chapters */
const chapters = [
  { pill:"A last honest page.", h:"Hopelessly Devoted to <span class='accent'>You</span>.", c:"This isn’t a proposal.<br/>It’s a clean ending — with respect.", title:"Chapter 1",
    body:"I won’t chase you for an answer anymore. I’ll say what’s true once — and then I’ll be quiet.",
    footer:"No more pushing. No more pressure."
  },
  { pill:"No bargaining.", h:"I liked you <span class='accent'>for real</span>.", c:"And that’s exactly why I won’t turn it into noise.", title:"Chapter 2",
    body:"If my presence ever felt heavy, I’m sorry. Liking someone doesn’t give me the right to take their space.",
  ...
  { pill:"No-contact pledge.", h:"I will <span class='accent'>not</span> disturb you.", c:"Not as a tactic. Not as drama. Just discipline.", title:"Chapter 3",
    body:"Starting now: no texts, no calls, no checking, no ‘just one more time’. You won’t have to block me to get peace.",
    footer:"Your silence will be honored."
  },
  { pill:"Still devoted…", h:"…but still <span class='accent'>respectful</span>.", c:"Soft feelings. Firm boundaries.", title:"Chapter 4",
    body:"I’ll keep the good things privately, without turning them into a reason to show up again. I’ll move forward quietly — like an adult.",
    footer:"No more appearances."
  },
  { pill:"Last page.", h:"I wish you <span class='accent'>peace</span>.", c:"Even if it’s without me.", title:"Chapter 5",
    body:"If you ever want to speak someday, it should be because you want to — not because I kept knocking. Until then, I’m done disturbing your life.",
